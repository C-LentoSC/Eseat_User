    ...
    <>
      ...
      <div className=" min-h-[100vh]">
              ...
              {bookings.map((booking, index) => (
                <div key={index} className="p-4 border-b">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="text-sm text-gray-900">{booking.contactNo}</div>
        ...
        <div className="w-full my-container mt-16 flex justify-between flex-wrap lg:flex-nowrap gap-2 lg:gap-0">
          ...
          <label className="text-lg ">2025-01-18 | KNY49-1400-PT Colombo- Trincomalee</label>
        </div>
              ...
              {bookings1.map((booking, index) => (
                <div key={index} className="p-4 border-b">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="text-sm text-gray-900">{booking.totalBusFare}</div>
